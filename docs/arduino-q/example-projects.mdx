...
During the bootcamp, open **Arduino App Lab** on your computer (PC Hosted Mode), connect the UNO Q, pick an example, and click **Run**. App Lab is a desktop app, not a page you open in the browser.

For the click-by-click steps, see [Run Example Projects](/docs/arduino-q/run-example-projects).
